...
# Gera uma lista em ordem crescente (pior caso para o Heapsort)
worst_case_numbers = list(range(1, 51))

print("Números no pior caso (ordem crescente):")
print(worst_case_numbers)

# Ordena os números usando Heapsort
heapsort(worst_case_numbers)

print("\nNúmeros após a execução do Heapsort (devem estar ordenados):")
print(worst_case_numbers)
